...
lr_list_mse_cubicrelu_mnist = {
    ...
    "w1_10_w2_40": [0.0002, 0.0003, 0.0004],
...
for weight in ["w1_10_w2_40"]:
    for lr in lr_list_mse_relu_mnist[weight]: # must over 2/eta
        os.system(f"python src/gd.py mnist fc-relu-depth1  mse {lr} 10000 --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")
    
    for lr in lr_list_mse_cubicrelu_mnist[weight]:
        os.system(f"python src/gd.py mnist fc-cubic_relu-depth1  mse {lr} 10000 --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")  

    for lr in lr_list_huber_cubicrelu_outer_mnist[weight]:
        os.system(f"python src/gd.py mnist fc-cubic_relu-outer  huber {lr} 10000 --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")  
    
    for lr in lr_list_mse_tanh_mnist[weight]:
        os.system(f"python src/gd.py mnist fc-tanh-depth1  mse {lr} 10000 --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")

    for lr in lr_list_huber_relu_mnist[weight]:
        os.system(f"python src/gd.py mnist fc-relu-depth1  huber {lr} 10000 --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")

    for lr in lr_list_huber_tanh_mnist[weight]:
        os.system(f"python src/gd.py mnist fc-tanh-depth1  huber {lr} 10000 --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")

    for lr in lr_list_mse_relu_BN_mnist[weight]:
        os.system(f"python src/gd.py mnist fc-relu-depth1  mse {lr} 10000 --batch_norm --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")  
