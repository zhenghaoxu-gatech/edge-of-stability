...
lr_list_huber_cubicrelu = {
    "w1_6_w2_20": [0.0001, 0.0003, 0.0005, 0.0007],
    }
...
# for weight in ["w1_6_w2_20"]:
    ...
    # for lr in lr_list_mse_tanh[weight]:
        # os.system(f"python src/gd.py cifar10-1k fc-tanh-depth1  mse {lr} 100000 --neigs 1  --eig_freq 400 --width 200 --init_weight {weight}")
...
# for weight in ["w1_3_w2_10"]:
    ...
    # for lr in [0.000016]:
        # os.system(f"python src/gd.py cifar10-1k fc-cubic_relu-outer  huber {lr} 200000 --neigs 1  --eig_freq 400 --width 200 --init_weight {weight}")  

'''
LayerNorm
'''
for weight in ["w1_6_w2_20"]:
    # for lr in lr_list_mse_relu_LN[weight]:
    for lr in [0.01, 0.02]:
        os.system(f"python src/gd.py cifar10-1k fc-tanh-depth1  mse {lr} 400 --layer_norm --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")  
        # os.system(f"python src/gd.py cifar10-1k fc-tanh-depth1  huber {lr} 4000 --layer_norm --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")  
        os.system(f"python src/gd.py cifar10-1k fc-relu-depth1  mse {lr} 400 --layer_norm --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")  
        # os.system(f"python src/gd.py cifar10-1k fc-relu-depth1  huber {lr} 4000 --layer_norm --neigs 1  --eig_freq 40 --width 200 --init_weight {weight}")  
